...
(function () {
  ...
  var I18N = {
    fr: {
      ...
      "houses.p": "Deux dossiers réels en cours à Cincinnati, écrits comme nous écrivons tout: achat, travaux, chiffres cibles. Le troisième montre la route locative, en dossier type. Les chiffres sont des objectifs, pas des promesses ni une offre. Cliquez sur une maison pour le détail complet.",

      "lbl.buy": "Achat",
      "lbl.works": "Travaux",
      "lbl.carry": "Portage et frais de vente, estimation",
      "lbl.fin": "Financement et frais de closing",
      "lbl.hold": "Portage, estimation",
      "lbl.sell": "Frais de vente, estimation",
      "lbl.worksA": "Travaux, bloqués chez le prêteur",
      "lbl.worksB": "Travaux, devis à prix ferme",
      ...
      "house1.name": "1313 Landis Lane, Cincinnati, Ohio",
      "house1.city": "4 chambres, 1 salle de bain, 110 m2. Closing le 17 août",
      "house2.name": "1611 Goodman Avenue, Cincinnati, Ohio",
      "house2.city": "De 1 à 4 chambres, sous-sol complet. En analyse",
      ...
      "badge.real": "Dossier réel. Chiffres cibles, pas des promesses.",
      "btn.file": "Voir le dossier",

      "dlg.numbers": "Les chiffres, tels qu'écrits au dossier",
      "dlg.works.t": "Les travaux",
      "house1.works": "Remise au standard du quartier: peinture complète, sols, cuisine, salle de bain, contrôle des systèmes, façade. Le budget travaux est bloqué chez le prêteur et libéré tranche par tranche à l'avancement.",
      "house2.works": "Nouveau plan en quatre chambres, cuisine et salle de bain, sols et peinture, sous-sol assaini, systèmes vérifiés. Devis de rénovation à prix ferme en main.",
    ...
    es: {
      ...
      "houses.p": "Dos expedientes reales en curso en Cincinnati, escritos como escribimos todo: compra, obras, cifras objetivo. El tercero muestra la vía del alquiler, como expediente tipo. Las cifras son objetivos, no promesas ni una oferta. Haga clic en una casa para el detalle completo.",

      "lbl.buy": "Compra",
      "lbl.works": "Obras",
      "lbl.carry": "Tenencia y costos de venta, estimación",
      "lbl.fin": "Financiamiento y costos de cierre",
      "lbl.hold": "Tenencia, estimación",
      "lbl.sell": "Costos de venta, estimación",
      "lbl.worksA": "Obras, bloqueadas con el prestamista",
      "lbl.worksB": "Obras, presupuesto a precio fijo",
      ...
      "house1.name": "1313 Landis Lane, Cincinnati, Ohio",
      "house1.city": "4 habitaciones, 1 baño, 110 m2. Cierre el 17 de agosto",
      "house2.name": "1611 Goodman Avenue, Cincinnati, Ohio",
      "house2.city": "De 1 a 4 habitaciones, sótano completo. En análisis",
      ...
      "badge.real": "Expediente real. Cifras objetivo, no promesas.",
      "btn.file": "Ver el expediente",

      "dlg.numbers": "Los números, tal como se escriben en el expediente",
      "dlg.works.t": "Las obras",
      "house1.works": "Puesta al estándar del barrio: pintura completa, pisos, cocina, baño, revisión de sistemas, fachada. El presupuesto de obra queda bloqueado con el prestamista y se libera por etapas según avance.",
      "house2.works": "Nueva distribución en cuatro habitaciones, cocina y baño, pisos y pintura, sótano saneado, sistemas verificados. Presupuesto de renovación a precio fijo en mano.",
